 ...
 *
 * @type    string            $object_type        The type of object for objects in the 'object' array. It's expected
 *          for this template that the type is 'Registration'
 ...
 * @type    string            $template_slug      The slug for the template.  For this template it will be
 *          'simple_list_table'
